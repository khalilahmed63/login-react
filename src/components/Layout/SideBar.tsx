  ...
  return (
    <>
      <Box
        ...
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto pt-20 flex flex-col justify-between items-start select-none">
          <div className=" pt-3  w-full bg-[#2E808E]">
            ...
            <div className="border-b border-[#0B3F47]">
              <p
                className={`${
                  monitor && "border-yellow-300 hover:border-yellow-300"
                } flex items-center py-[0.7rem] pl-6 border-l-4 text-lg bg-[#2E808E] border-[#2E808E] hover:border-[#23626b] text-white hover:bg-[#23606B] cursor-pointer`}
                onClick={() => {
                  setMonitor(!monitor);
                }}
              >
            ...
            <div className="border-b border-[#0B3F47]">
              <p
                className={`${
                  manage && "border-yellow-300 hover:border-yellow-300 "
                } flex items-center py-[0.7rem] pl-6 border-l-4 text-lg border-[#2E808E] hover:border-[#23626b] text-white hover:bg-[#23606B] cursor-pointer  bg-[#2E808E]`}
                onClick={() => {
                  setManage(!manage);
                }}
              >
            ...
            <div className={`${manage ? "block" : "hidden"} duration-300`}>
              ...
              <div className="border-b border-[#0B3F47]">
                <Link to="/deviceGroups">
                  ...
                  >
                    <span className="ml-3">Device Group</span>
                  </p>
                </Link>
              </div>
              <div className="border-b border-[#0B3F47]">
            ...
            <div className="border-b border-[#0B3F47]">
              <p
                className={`${
                  onboard && "border-yellow-300 hover:border-yellow-300 "
                } flex items-center py-[0.7rem] pl-6 border-l-4 text-lg border-[#2E808E] hover:border-[#23626b] text-white hover:bg-[#23606B] cursor-pointer  bg-[#2E808E]`}
                onClick={() => {
                  setOnboard(!onboard);
                }}
            ...
            <div className={`${onboard ? "block" : "hidden"} duration-300 `}>
              <div className="border-b border-[#0B3F47]">
                <Link to="/projects/new">
                  <p
                    className={`${
                      onboard && "border-yellow-300 hover:border-yellow-300 "
                    } flex items-center py-[0.7rem] pl-16 border-l-4 text-lg border-[#2E808E] hover:border-[#23626b]  text-white hover:bg-[#23606B] ${
                      location.pathname.endsWith("/projects/new") &&
                      "  bg-[#0B3F47] hover:border-yellow-300  border-yellow-300 font-bold"
                    }`}
                  >
              ...
              <div className="border-b border-[#0B3F47]">
                <Link to="/deviceGroups/new">
                  ...
                  >
                    <span className="ml-3">New Device Group</span>
                  </p>
                </Link>
              </div>
              <div className="border-b border-[#0B3F47]">
